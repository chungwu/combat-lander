...
export const TURN_RATE = Math.PI * 0.5; // rad/s
...
// Sync mechanics
export const PARTIAL_SYNC_FREQ = 60 * 5; // once per second
...
export const JOYSTICK_CONFIG: {use: boolean, scheme: "keyboard" | "angled" | "mixed" | "duo", threshold: number} = {
  use: false,
  scheme: "angled",
  threshold: 0.1
};
